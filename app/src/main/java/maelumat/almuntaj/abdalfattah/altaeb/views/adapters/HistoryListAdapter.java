...
import maelumat.almuntaj.abdalfattah.altaeb.views.holders.HistoryScanHolder;
...
public class HistoryListAdapter extends RecyclerView.Adapter<HistoryScanHolder> {
    ...
    public void onBindViewHolder(HistoryScanHolder holder, int position) {
        ...
        if (!isLowBatteryMode) {
            ...
            holder.imgProduct.setBackground(mActivity.getResources().getDrawable(R.drawable.placeholder));
